                    ...
                    <div id="basic" class="tab-pane fade show active">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="description" class="form-control rich-editor">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="details" class="tab-pane fade">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="features" class="form-control rich-editor">{{ old('features') }}</textarea>
                            </div>

                            <div class="col-md-12 mb-3">
                                <label class="form-label">Benefits</label>
                                <textarea name="benefits" class="form-control rich-editor">{{ old('benefits') }}</textarea>
                            </div>

                            <div class="col-md-12 mb-3">
                                <label class="form-label">Branding Options</label>
                                <textarea name="branding_options" class="form-control rich-editor">{{ old('branding_options') }}</textarea>
                            </div>

                            <div class="col-md-4 mb-3">
                                <label class="form-label">Seed Type</label>
                                <input type="text" name="seed_type" class="form-control" value="{{ old('seed_type') }}">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="moq" class="form-control" value="{{ old('moq', 100) }}">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check form-switch">
                                            ...
                                            <input type="checkbox" name="is_new" class="form-check-input" id="is_new" value="1" {{ old('is_new') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check form-switch">
                                            ...
                                            <input type="checkbox" name="is_bestseller" class="form-check-input" id="is_bestseller" value="1" {{ old('is_bestseller') ? 'checked' : '' }}>
