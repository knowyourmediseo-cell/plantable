...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0"><i class="fas fa-envelope-open-text me-2 text-primary"></i>Edit Template: {{ $emailTemplate->name }}</h1>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="body" class="form-control rich-editor @error('body') is-invalid @enderror"
                        rows="15">{{ old('body', $emailTemplate->body) }}</textarea>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="variables" class="form-control"
                        value="{{ old('variables', is_array($emailTemplate->variables) ? implode(', ', $emailTemplate->variables) : $emailTemplate->variables) }}">
                ...
                <div class="col-md-4">
                    <div class="form-check form-switch mt-2">
                        ...
                        <input type="checkbox" name="status" class="form-check-input" id="status" value="1" {{ old('status', $emailTemplate->status) ? 'checked' : '' }}>
