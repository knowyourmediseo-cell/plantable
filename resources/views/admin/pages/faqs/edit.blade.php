            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="answer" class="form-control rich-editor @error('answer') is-invalid @enderror" rows="6">{{ old('answer', $faq->answer) }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                ...
                                <input class="form-check-input" type="checkbox" name="is_featured" value="1" id="is_featured" {{ old('is_featured',$faq->is_featured) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                ...
                                <input class="form-check-input" type="checkbox" name="status" value="1" id="status" {{ old('status',$faq->status) ? 'checked' : '' }}>
