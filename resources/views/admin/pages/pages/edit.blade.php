                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="content" class="form-control rich-editor @error('content') is-invalid @enderror" rows="15">{{ old('content', $page->content) }}</textarea>
                            ...
                            <div class="image-preview-container mt-3">
                                @if($page->featured_image)
                                    <div class="position-relative d-inline-block">
                                        <img src="{{ asset('uploads/pages/' . $page->featured_image) }}" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                    ...
                    <div class="card-body">
                        <div class="image-upload-wrapper">
                            ...
                            <div class="image-preview-container mt-3">
                                @if($page->banner)
                                    <div class="position-relative d-inline-block">
                                        <img src="{{ asset('uploads/pages/' . $page->banner) }}" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                        <button type="button" class="btn btn-danger btn-sm position-absolute top-0 end-0 remove-image-btn" style="margin: 5px;">
                                            <i class="fas fa-times"></i>
                                        </button>
                                    </div>
